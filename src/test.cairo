...
fn test_valid_hash() {
    ...
    set_caller_address(contract_address_const::<0x01b218bb213ce9b1aa30461b7404ad55c334726ebd241831e53a8c24e570936f>());
    let address = get_caller_address();
    let message = simple_struct.get_message_hash();
    assert(simple_struct.get_message_hash() == message_hash, message);
}
